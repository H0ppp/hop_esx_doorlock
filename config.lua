...
Config.DoorList = {
	...
	--Benny's
	{
		objHash = GetHashKey('v_ilev_fib_door_maint'),
		objHeading = 270.0,
		objCoords = vector3(-208.2, -1341.6, 30.89),
		textCoords = vector3(-208.2, -1341.6, 30.89),
	...
	},
	{
		...
		objHeading = 90.0,
		objCoords = vector3(-197.84, -1341.85, 30.89),
		textCoords = vector3(-197.84, -1341.85, 30.89),
		authorizedJobs = {'mechanic'},
		locked = true,
		maxDistance = 1.25
	},
	{
		objHash = GetHashKey('portabennysking_door_01'),
		objCoords = vector3(-201.6, -1310.36, 31.3),
		textCoords = vector3(-201.6, -1310.36, 31.3),
		authorizedJobs = {'mechanic'},
		locked = false,
		maxDistance = 12,
		size = 2
	...
	--Yard gates
	{
		textCoords = vector3(-220.41, -1291.98, 31.8),
		authorizedJobs = {'mechanic'},
		locked = true,
		maxDistance = 12,
		size = 2,
		doors = {
			{objHash = GetHashKey('prop_facgate_03_l'), objHeading = -180.0, objCoords  = vector3(-215.2953, -1291.791, 31.62653)},
			{objHash = GetHashKey('prop_facgate_03_r'), objHeading = -180.0, objCoords  = vector3(-225.4175, -1291.784, 31.62653)}
		}
	}
}